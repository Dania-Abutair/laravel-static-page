            ...
            <ul class="row">
                ...
                <li class="col-12 col-md-6 col-lg-3">
                    <div class="cnt-block equal-hight" style="height: 349px;">
                        ...
                        <figure><img src="<?php echo $value['image']?>" class="img-responsive" alt=""></figure>

                        <h3><a href="/trainee/<?php echo $value['id'] ?>"><?php echo $value['name']  ?></a></h3>
                        <h5><?php echo $value['birthday'] ?></h5>
                        <p>Freelance Web Developer</p>
                        <ul class="follow-us clearfix">
                            <li><a href="<?php echo $value['github account'] ?> "><i class="fa fa-github" aria-hidden="true"></i></a></li>
